            ...
            >
              ...
              <div className="md:col-span-5 md:col-start-8">
                {alumnus.photo ? (
                  ...
                  // bg-paper: matches every other Placeholder on the site —
                  // its own bg-gold/5 is translucent by design, and this one
                  // sits directly on the section's own paper background.
                  <Placeholder
                    kind="Foto"
                    label={alumnus.name}
                    ratio="3 / 4"
