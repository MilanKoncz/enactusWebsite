...
| `content/alumni.ts` | Alumni-Einträge (Namen, aktuelle Position, Zitat, LinkedIn, Foto) | Foto: quadratisch | Platzhalter aktiv (missing) — 3 Einträge `ALUMNUS_1`–`ALUMNUS_3` mit `POSITION_n`/`STATEMENT_n`, Rest `null` |
